...
public class Question_5 extends ScreenAdapter{
	Game game;
	SpriteBatch batch;
	Lives lives;
	Texture question_5;
	...
	public Question_5(Game game)
	{
		this.game = game;
		batch = new SpriteBatch();
		question_5 = new Texture("question_5.png");
		lives = new Lives();
		skip = new Skip();
		sound = new SoundFx();
...
//			System.out.println(touchPoint);
			...
			if(ans1.contains(touchPoint))
			{
				...
				game.setScreen(new Question_6(game));
				dispose();
			}
