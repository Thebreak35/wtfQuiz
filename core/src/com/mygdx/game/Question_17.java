...
public class Question_17 extends ScreenAdapter{
	Game game;
	SpriteBatch batch;
	Texture question_17;
	Lives lives;
	...
	public Question_17(Game game) {
		this.game = game;
		batch = new SpriteBatch();
		question_17 = new Texture("question_17.png");
		lives = new Lives();
		skip = new Skip();
		sound = new SoundFx();
		...
		trueAnswer = new Rectangle( 290, 50 - 30, 60, 50);
	}
	...
	private void update() {
		if (Gdx.input.justTouched()) {
			...
			if (trueAnswer.contains(touchPoint)) {
				...
				game.setScreen(new Question_18(game));
				dispose();
			}
